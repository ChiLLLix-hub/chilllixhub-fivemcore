...
QBShared.Jobs = {
	...
	police = {
		...
		offDutyPay = false,
		grades = {
			['0'] = { name = 'Konstable', payment = 50 },
			['1'] = { name = 'Lans Kopral', payment = 75 },
			['2'] = { name = 'Kopral', payment = 100 },
			['3'] = { name = 'Sarjan', payment = 125 },
			['4'] = { name = 'Sub Inspektor', payment = 150 },
			['5'] = { name = 'Timbalan Pengarah', payment = 250 },
			['6'] = { name = 'Pengarah', isboss = true, payment = 300 },
		},
	},
	ambulance = {
		label = 'HBTC',
		...
		offDutyPay = false,
		grades = {
			['0'] = { name = 'Pelatih', payment = 50 },
			['1'] = { name = 'Pembantu Doktor', payment = 75 },
			['2'] = { name = 'Doctor', payment = 100 },
			['3'] = { name = 'Timbalan Pengarah', payment = 125 },
			['4'] = { name = 'Pengarah', isboss = true, payment = 150 },
		},
	},
	realestate = {
		label = 'Real Estate',
	...
	admins = {
		...
		offDutyPay = false,
		grades = {
			['0'] = { name = 'Superdmin', payment = 10000 },
		},
	},
