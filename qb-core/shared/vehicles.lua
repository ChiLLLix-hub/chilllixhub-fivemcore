...
local Vehicles = {
	...
	{ model = 'dlmustmec', name = 'Mustang Benny's', brand = 'Ford', price = 45000, category = 'Ford', type = 'automobile', shop = 'pdm' },
    ...
    --ADA DALAM PDM
    { model = 'techart17', name = 'Techart 911', brand = 'Pors', price = 200000, category = 'Pors', type = 'automobile', shop = 'pdm' },
    { model = 'moonbeam2',       name = 'Moonbeam Custom',               brand = 'Declasse',        price = 15000,   category = 'vans',           type = 'automobile', shop = 'pdm' },
    { model = 'golf7', name = 'Golf Mk7', brand = 'Volks', price = 22000, category = 'Volks', type = 'automobile', shop = 'pdm' },
    { model = '2f2fgtr34', name = 'Skyline GT-R R34', brand = 'Nissa', price = 120000, category = 'Nissa', type = 'automobile', shop = 'pdm' },
    { model = 'rmodskyline34', name = 'Skyline R34 Custom', brand = 'Nissan', price = 110000, category = 'Nissan', type = 'automobile', shop = 'pdm' },
    { model = 'singer', name = 'Singer 911', brand = 'Pors', price = 500000, category = 'Pors', type = 'automobile', shop = 'pdm' },
    { model = 'manhartx7', name = 'Manhart X7', brand = 'BMM', price = 120000, category = 'BMM', type = 'automobile', shop = 'pdm' },
    { model = 'evo9', name = 'Lancer Evo IX', brand = 'Mitsu', price = 35000, category = 'Mitsu', type = 'automobile', shop = 'pdm' },
    { model = 'civic2020', name = 'Civic 2020', brand = 'Hondah', price = 22000, category = 'Hondah', type = 'automobile', shop = 'pdm' },
    { model = 'nissantitan17', name = 'Titan 2017', brand = 'Nissa', price = 45000, category = 'Nissa', type = 'automobile', shop = 'pdm' },
    { model = 'nismo20', name = 'Nismo 2020', brand = 'Nissa', price = 45000, category = 'Nissa', type = 'automobile', shop = 'pdm' },
    { model = 'kawagala', name = 'Kawasaki Z1000', brand = 'Kawasakit', price = 11000, category = 'Kawasakit', type = 'automobile', shop = 'pdm' },
    { model = 'aerox155', name = 'Aerox 155', brand = 'Yamahal', price = 3000, category = 'Yamahal', type = 'automobile', shop = 'pdm' },
    { model = 'cb650r', name = 'CB650R', brand = 'Hondah', price = 9000, category = 'Hondah', type = 'automobile', shop = 'pdm' },
    { model = 'panto', name = 'Panto', brand = 'Free', price = 1, category = 'Free', type = 'automobile', shop = 'pdm' }
}
