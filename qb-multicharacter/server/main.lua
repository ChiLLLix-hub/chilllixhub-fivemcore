...
RegisterNetEvent('qb-multicharacter:server:createCharacter', function(data)
    ...
    if QBCore.Player.Login(src, false, newData) then
        ...
        if GetResourceState('qb-apartments') == 'started' and Apartments.Starting then
            ...
            -- Debug: TOS trigger point for new character (with apartments)
            print('^3[qb-multicharacter]^7 TOS Triggered! (New character created: ' .. newData.cid .. ')')
        else
            print('^2[qb-core]^7 ' .. GetPlayerName(src) .. ' has successfully loaded!')
            QBCore.Commands.Refresh(src)
            loadHouseData(src)
            ...
            GiveStarterItems(src)
            -- Debug: TOS trigger point for new character (without apartments)
            print('^3[qb-multicharacter]^7 TOS Triggered! (New character created: ' .. newData.cid .. ')')
